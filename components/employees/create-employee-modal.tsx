    ...
    <div className="fixed inset-0 bg-overlay flex items-center justify-center z-50 p-4">
      <div className="bg-surface rounded-lg p-4 sm:p-6 w-full max-w-md border border-border max-h-[90vh] overflow-y-auto">
        <div className="flex items-center justify-between mb-4 sm:mb-6">
          <h2 className="text-xl sm:text-2xl font-bold text-foreground">Add New Employee</h2>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            <Label htmlFor="name">
              <span className="text-destructive">*</span> Employee Name
            </Label>
            <Input
              id="name"
              value={formData.name}
          ...
          <div className="space-y-2">
            <Label htmlFor="designation">
              <span className="text-destructive">*</span> Designation
            </Label>
            <select
              id="designation"
          ...
          <div className="space-y-2">
            <Label htmlFor="base_salary">
              <span className="text-destructive">*</span> Base Salary (Monthly)
            </Label>
          ...
          <div className="space-y-2">
            <Label htmlFor="join_date">
              <span className="text-destructive">*</span> Joining Date
            </Label>
            <Input
              id="join_date"
              type="date"
