...
export function SettleReferralCommissionModal({
  ...
  const fetchCommissions = async () => {
    try {
      setLoading(true)
      const response = await apiFetch('/api/finances/referral-commissions?settled=false')
  ...
  const handleSettle = async () => {
    ...
    try {
      setSettling(true)
      const response = await apiFetch('/api/finances/referral-commissions', {
        method: 'POST',
                  ...
                  >
                    <div className="flex items-start gap-3">
                      <input
                        ...
                        className="mt-1 w-4 h-4 rounded border-border text-accent focus:ring-ring"
                      />
          ...
          <div className="p-4 sm:p-6 border-t border-border bg-surface-hover">
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-4">
              ...
              <button
                ...
                disabled={settling}
                className="px-6 py-3 bg-accent hover:bg-accent-hover disabled:bg-surface-inset disabled:cursor-not-allowed text-foreground rounded-lg font-medium transition-colors flex items-center justify-center gap-2"
              >
                {settling ? (
                  <>
