...
_Last updated 2026-09-25 · **nothing open** · every CR built_
...
Nothing. New questions will appear here.

---

### Answered — round 7

- **Q-99 — the Dashboard is removed.** *"Go with what is best."* → Option A: the placeholder of zeros is gone and **everyone, the admin included, lands on Patients** after signing in. A real dashboard can be designed later if you want one (the figures in option B all exist already).
