...
| 3 | ✅ ~~**Live refresh never fires on 11 screens**~~ — the lab worklist, charge sheets, petty cash, the charge catalogue, parts of the case sheet — because their tables were never added to the live-refresh stream (BUGS #75). | Those screens update only after your own action or a reload. | **Fixed 2026-09-25** with #68 step 3. |
